    ...
    <section className="UserContenedor">
      {!usuario ? (
        ...
        <div className="UserCuadro UserInfo">
          ...
          <p className="UserRol"><strong>Programa: </strong>{usuario?.perfilAprendiz?.ProgramaFormacion || "No aplica"}</p>
          <p className="UserRol"><strong>Ficha: </strong>{usuario?.perfilAprendiz?.Ficha || "No aplica"}</p>
          <p className="UserRol"><strong>Jornada: </strong>{usuario?.perfilAprendiz?.Jornada || "No aplica"}</p>
          <p className="UserRol"><strong>Teléfono: </strong>{usuario.Telefono}</p>
